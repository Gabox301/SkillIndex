...
describe('collectSkills', () => {
  ...
  it('does not duplicate frontend bonus skills if already present', () => {
    const detected = [{ id: 'custom', name: 'Custom', detect: {}, skills: ['anthropics/skills/frontend-design'] }];
    const skills = collectSkills({ detected, isFrontend: true });
  ...
  it('adds skills from combo skills', () => {
    const detected = [{ id: 'expo', name: 'Expo', detect: {}, skills: ['expo/skills/building-native-ui'] }];
    const combos = [
      {
        id: 'expo-tailwind',
  ...
  it('deduplicates combo skills already present from techs', () => {
    const detected = [{ id: 'expo', name: 'Expo', detect: {}, skills: ['expo/skills/expo-tailwind-setup'] }];
    const combos = [
      {
        id: 'expo-tailwind',
        name: 'Expo + Tailwind CSS',
  ...
  it('marks frontend bonus skills as installed when present in installedNames', () => {
    ...
    strictEqual(skills.find((s) => s.skill === 'anthropics/skills/frontend-design')!.installed, true);
  });
});
